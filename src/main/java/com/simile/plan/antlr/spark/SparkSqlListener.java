...
public interface SparkSqlListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link SparkSqlParser#multiStatement}.
	 * @param ctx the parse tree
	 */
	void enterMultiStatement(SparkSqlParser.MultiStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparkSqlParser#multiStatement}.
	 * @param ctx the parse tree
	 */
	void exitMultiStatement(SparkSqlParser.MultiStatementContext ctx);
	/**
